...
class Board
  ...
  def possible_knight_moves
    current = @root.next
    possible_knight_space1 = current.next
    while !(current.nil?)

      current.knight_move1(possible_knight_space1)
      possible_knight_space1 = possible_knight_space1.next
      
      if possible_knight_space1.nil?
        current = current.next
        possible_knight_space1 = @root.next
      end
    end
  end
end
